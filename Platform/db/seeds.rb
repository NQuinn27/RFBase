...
puts "Customer One Created with ID: #{customer_one.id}"
#Customer Admin User
...
puts "Customer Two Created with ID: #{customer_two.id}"
CustomerAdmin.create :first_name => "Sam", :last_name => "Jones", :email => "niall+samJones@niallquinn.me", :password => "samJones", :password_confirmation => "samJones", :customer_id => customer_two.id
...
puts "Customer Three Created with ID: #{customer_three.id}"
CustomerAdmin.create :first_name => "Jennifer", :last_name => "Kelly", :email => "niall+jenniferKelly@niallquinn.me", :password => "jenniferKelly", :password_confirmation => "jenniferKelly", :customer_id => customer_three.id
